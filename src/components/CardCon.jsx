...
const CardCon = () => {
    return (
        <div className='py-12 md:py-20 px-6 md:px-40 text-center bg-base-200'>
            ...
            <p className='small-text text-lg md:text-2xl text-gray-500 leading-8 md:leading-10 py-4' >Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet, harum?</p>
