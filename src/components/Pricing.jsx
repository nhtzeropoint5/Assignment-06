...
const Pricing = () => {
    ...
    return (
          <div className='py-12 md:py-20 px-6 md:px-40 text-center'>
            ...
            <p className='small-text mb-8 md:mb-14 text-lg md:text-2xl text-gray-500 leading-8 md:leading-10' >Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
